(function () {
    ...
    function sendApiRequest(ip){
        ...
        var requestUrl = "";
        if(ip){
            requestUrl = domainUrl + "api/fg/getads?id=" + sysChannelInfo.vestid + '&ip=' + ip + "&channel_id=" + sysChannelInfo.channelid;
        } else {
            requestUrl = domainUrl + "api/fg/getads?id=" + sysChannelInfo.vestid + "&channel_id=" + sysChannelInfo.channelid;
        }
    ...
    function getBlackListIp(domainUrl){
        ...
        var ip;
        var index = 0;
        var reqUrl = ['https://api.ipify.org/?format=json', 'https://ifconfig.co/json', 'http://ip-api.com/php'];
